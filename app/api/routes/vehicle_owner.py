...
from app.crud.vehicle_owner import create_user, update_aadhar_image
...
async def signup(
    ...
    try:
        ...
        # Re-raise HTTP exceptions (like duplicate mobile number)
        raise
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to update image URL: {e}")
